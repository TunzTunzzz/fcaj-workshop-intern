...
* Tìm hiểu sâu về quản lý bảo mật nâng cao và thực hành bật AWS Security Hub.
* Học cách tự động hóa các tác vụ quản lý hạ tầng (start/stop EC2) bằng AWS Lambda, IAM Roles và webhooks.
* Nắm vững chiến lược quản lý tài nguyên (Gắn thẻ, Resource Groups) và các giới hạn truy cập chi tiết bằng IAM.

### Nhiệm vụ thực hiện trong tuần này:
| Ngày | Nhiệm vụ | Ngày bắt đầu | Ngày hoàn thành | Tài liệu tham khảo |
| --- | --- | --- | --- | --- |
| 2 | Học bổ sung nội dung thực hành/nghiên cứu về bảo mật và thực hành bật AWS Security Hub. | 25/05/2026 | 25/05/2026 | [Xem&nbsp;Youtube](https://www.youtube.com/watch?v=YnLo4MgOXyA&list=PLahN4TLWtox2a3vElknwzU_urND8hLn1i&index=158) |
