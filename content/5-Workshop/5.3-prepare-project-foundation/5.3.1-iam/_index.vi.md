---
title: "5.3.1 Cấu hình IAM Roles"
date: 2024-01-01
weight: 1
chapter: false
pre: " <b> 5.3.1. </b> "
...
# Cấu hình IAM Policies và Roles cho hệ thống DocuFlow AI

Để tuân thủ nguyên tắc phân quyền tối thiểu (Least Privilege), chúng ta sẽ thiết kế và tạo các IAM Policy và Role chuyên biệt cho từng dịch vụ Lambda và Step Functions trong hệ thống.
...
### - Role 8: `docuflow-dev-ingestion-validate-lambda-role` (Quyền cho Lambda kiểm tra dữ liệu đầu vào)
...
* **Các bước thực hiện**:
  ...
  9. Bấm **Next**. Đặt Role Name: `docuflow-dev-ingestion-validate-lambda-role`.
